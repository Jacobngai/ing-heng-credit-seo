...
const $$Backhoe = createComponent(($$result, $$props, $$slots) => {
  const lang = "en";
  const pageTitle = "Stop Renting Backhoes - Own with 0% Deposit | CASE, JCB, CAT Financing";
  const pageDescription = "Stop paying RM 8k monthly rental. Finance used backhoes with 0% deposit. No more rental limits or availability issues. CASE 580, JCB 3CX accepted. Equipment 10+ years old approved.";
  const keywords = ["backhoe financing Malaysia", "stop renting backhoe", "CASE 580 financing", "used backhoe financing", "JCB backhoe loan", "own vs rent backhoe"];
  const breadcrumbs = [
    { label: "Home", url: "/en" },
    { label: "Equipment", url: "/en/equipment" },
    { label: "Backhoe Financing", url: "/en/equipment/backhoe" }
  ];
  const benefits = [
    { icon: "clock", title: "Fast Approval", description: "Get approved quickly so you can bid on upcoming tenders. We understand contractors need equipment to qualify for government and telecoms contracts." },
    { icon: "percentage", title: "Excellent Approval Rate", description: "We approve experienced workers starting their own business. Banks reject first-time contractors - we see the opportunity." },
    { icon: "shield", title: "10+ Years Old Accepted", description: "Old backhoes still work. A 2015 CASE 580 digs trenches as well as a 2024 model. We finance proven equipment at affordable prices." },
    { icon: "users", title: "0% Deposit, 100% Financing", description: "Zero deposit required. Finance up to 100% of equipment value. Preserve your working capital for tender bonds and operational costs." },
    { icon: "document", title: "Simple Documentation", description: "IC, bank statements, company docs. If you have utility experience and tender opportunities, we can help." },
    { icon: "shield", title: "No Hidden Fees", description: "Transparent pricing. Rates from 7.5-12% per annum. No early repayment penalty. What you see is what you pay." }
  ];
  const faqs = [
    {
      question: "How much does it really cost to rent vs own a backhoe?",
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": pageTitle, "description": pageDescription, "lang": lang, "keywords": keywords, "ogType": "website" }, { "default": ($$result2) => renderTemplate`    ${maybeRenderHead()}<div class="container-custom py-4"> ${renderComponent($$result2, "Breadcrumbs", $$Breadcrumbs, { "items": breadcrumbs, "lang": lang })} </div>  ${renderComponent($$result2, "Hero", $$Hero, { "title": "Stop Renting Backhoes - Own Your Equipment with 0% Deposit", "subtitle": "Tired of RM 8,000 monthly rental fees? Limited hours? Equipment availability issues? Finance a used backhoe and control your business.", "ctaText": "Get Free Quote via WhatsApp", "ctaLink": "https://wa.me/60175700889?text=Hi!%20I%27d%20like%20to%20get%20a%20quote%20for%20backhoe%20financing.", "ctaSecondaryText": "Call Now: 017-570 0889", "ctaSecondaryLink": "tel:+60175700889", "lang": lang, "trustSignals": ["40 Years in Business", "KPKT Licensed", "4,000+ Companies Financed", "Equipment 10+ Years Old Accepted"] })}  <section class="section bg-[#F5F5DC]"> <div class="container-custom"> <div class="max-w-4xl mx-auto"> <h2 class="text-3xl md:text-4xl font-bold text-primary mb-8 text-center">
Stop Paying RM 8,000 Monthly Rental Forever
</h2> <div class="bg-white p-8 rounded-lg shadow-[6px_6px_0_#2D1810] mb-8"> <div class="prose max-w-none text-[#4F3E29] space-y-4"> <p>You're a small contractor. Foundation work. Site preparation. Utility jobs.</p> <p>You rent a backhoe when you need it. RM 8,000 per month.</p> <p>But rental comes with limits: 200 hours maximum.</p> <p>Your projects need 250-300 hours. You either:</p> <ul> <li>Rush the work (quality suffers)</li> <li>Pay RM 50 per extra hour (penalties add up fast)</li> <li>Turn down bigger jobs (can't commit without guaranteed equipment)</li> </ul> <p>Last month, you got a Saturday emergency call. Burst pipe, need trenching NOW. Weekend premium work: Worth RM 12,000.</p> <p>You call the rental company. Closed.</p> <p>You turn down RM 12,000. You sit at home. The job goes to a contractor who OWNS his backhoe.</p> <p>Does that missed revenue eat at you all weekend?</p> <p>When Monday comes and you see that contractor's Facebook post: "Weekend emergency job, saved the day" - and you know YOU could've done it if you owned equipment - does it sting?</p> <p>You've rented for 3 years. RM 8,000 monthly. That's RM 288,000.</p> <p>You could've OWNED a used backhoe after 18 months of those payments.</p> <p>But instead, you're still renting. Still limited. Still missing opportunities.</p> <div class="bg-red-50 border-l-4 border-red-500 p-4"> <p class="font-semibold">Found a used CASE 580. 8 years old. 2-in-1 machine: excavate AND load.</p> <p class="mt-2">Banks reject. "Too old."</p> </div> <p>But you know backhoes. Simple hydraulics. CASE machines from 1995 still working on Malaysian sites.</p> <div class="bg-green-50 border-l-4 border-green-500 p-4"> <p class="font-semibold">We approve equipment 10+ years old.</p> </div> <p>Your backhoe. Your schedule. Your weekend emergency revenue.</p> <p class="text-xl font-semibold text-primary">Own it. Control it. Never miss another opportunity.</p> <p class="text-lg font-semibold">Unlimited working hours. Always available for emergency jobs. Weekend revenue, all yours.</p> </div> </div> <div class="text-center"> <a href="https://wa.me/60175700889?text=Hi!%20I%27m%20tired%20of%20renting%20equipment.%20I%27d%20like%20to%20discuss%20backhoe%20financing." target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-lg inline-block">
...
</p> </div> <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-[6px_6px_0_#2D1810]"> <ul class="space-y-3 text-[#4F3E29]"> <li class="flex items-start"> <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path> </svg> <span><strong>CASE 580 Super M, 580L, 590</strong> - Industry workhorse. Simple hydraulics, parts everywhere.</span> </li> <li class="flex items-start"> <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path> </svg> <span><strong>JCB 3CX, 4CX</strong> - British engineering Malaysian contractors trust. Strong loader, deep dig.</span> </li> <li class="flex items-start"> <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path> </svg> <span><strong>CAT 416, 420, 428</strong> - Caterpillar durability. Last 20+ years in Malaysian conditions.</span> </li> <li class="flex items-start"> <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path> </svg> <span><strong>Terex, Komatsu Backhoes</strong> - Budget-friendly alternatives. Good for contractors starting out.</span> </li> </ul> <p class="text-center text-[#4F3E29] mt-6 font-semibold">...and more! Contact us for other brands.</p> </div> </div> </section>  <section class="section"> <div class="container-custom"> <div class="text-center mb-12"> <h2 class="text-3xl md:text-4xl font-bold text-primary mb-4">
